...
export default function PatientDetailsPage() {
  ...
  const [preFilledLabData, setPreFilledLabData] = useState<ToothDataFromChart | null>(null);
  ...
  const handleToothSelectForLabRequest = (toothNumber: number, toothData: ToothDataFromChart) => {
    setPreFilledLabData(toothData);
    setShowNewLabOrder(true);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-2 lg:p-6 pb-20" dir="rtl">
      <div className="max-w-7xl mx-auto space-y-4 lg:space-y-6">
            ...
            <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="text-sm font-medium text-gray-900 mb-2">جهة الاتصال في حالات ال��وارئ</div>
        ...
        {activeTab === "treatment" && (
          <PatientTreatmentPlan
            ...
            onToothSelectForLabRequest={handleToothSelectForLabRequest}
          />
        )}
      ...
      <NewLabOrderModal
        ...
        onClose={() => {
          ...
          setPreFilledLabData(null);
        }}
        patientId={patientId}
        preFilledToothData={preFilledLabData}
      />
